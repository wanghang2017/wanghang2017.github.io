...
export declare type MetamaskBTCRpcRequest = GetAllXpubsRequest | GetAddress | GetPublicExtendedKeyRequest | SignPsbt | GetMasterFingerprint | ManageNetwork | SaveLNDataToSnap | GetLNDataFromSnap | SignLNInvoice;
export declare type BTCMethodCallback = (originString: string, requestObject: MetamaskBTCRpcRequest) => Promise<unknown>;
...
export declare enum KeyOptions {
    Password = "password",
    Credential = "credential",
    PubKey = "pubkey"
}
export declare const LNHdPath: string;
